...
| `teams` | 5,653 | N/A | **tag**: 98.30%<br>**veto_tag**: 73.06% |
| `maps` | 68,366 | 32390 | **picked_by_team_id**: 59.59%<br>**duration_seconds**: 5.12%<br>**team1_score_ct**: 1.16%<br>**team2_score_ct**: 1.17%<br>**team1_score_t**: 1.17%<br>**team2_score_t**: 1.17%<br>**team1_score_ot**: 89.83%<br>**team2_score_ot**: 89.83% |
...
| `series_kill_matrix` | 520,550 | 20822 | **player_team_id**: 21.69%<br>**opponent_team_id**: 21.75%<br>**diff**: 0.01% |
| `series_advanced_stats` | 209,312 | 20822 | **team_id**: 21.73%<br>**k2**: 0.89%<br>**k3**: 18.43%<br>**k4**: 67.96%<br>**k5**: 95.43%<br>**clutch_1v1**: 61.99%<br>**clutch_1v2**: 77.96%<br>**clutch_1v3**: 93.38%<br>**clutch_1v4**: 98.75%<br>**clutch_1v5**: 99.87% |
| `series_economy` | 41,644 | 20822 | **team_id**: 17.47% |
| `map_vetos` | 94,146 | 14077 | **team_id**: 14.62%<br>**team_tag**: 14.18% |
...
- **Veto Action Resolution Rate**: 99.49% (80,382 resolved vs 412 unresolved)
- **Maps Pick Attribution**:
  - Maps with picking team resolved: 27,629
  - Maps with null picking team: 40,737
